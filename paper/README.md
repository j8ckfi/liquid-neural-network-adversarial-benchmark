...
- Derived key stats: [`paper_artifacts/key_results.json`](/Users/j8ck/research/paper_artifacts/key_results.json)

## Notes
- All figures in the manuscript are seaborn-generated PNG outputs from `publishable_benchmark_v2.py`.
- The manuscript tables are derived from `aggregate_summary.json` and `raw_results.json`.
